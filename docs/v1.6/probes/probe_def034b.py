...
# B. REAL canonical append via capture store
root = tmp / "canonical"
store = JsonlCaptureStore(CaptureStoreConfig(root))
env = normalize_event({"text": "hello", "redaction_audit": []}, profile_id="p1", project_id="P",
...
# F. authorization: space grant per-row
