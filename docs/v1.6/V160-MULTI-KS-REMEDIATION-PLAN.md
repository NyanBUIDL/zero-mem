...
### C2 — Ingest denormalize: zm_event_spaces junction + PRIMARY-KS (migration additive) — **DONE (commit 617ed92 + follow-up 0e3abc9 + round-2, SHA ở docs follow-up)**
