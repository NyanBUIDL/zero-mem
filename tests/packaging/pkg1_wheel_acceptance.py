...
Usage: python tests/packaging/pkg1_wheel_acceptance.py dist/zero_mem-1.2.0-py3-none-any.whl
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="pkg1-", dir=str(test_root)) as temp:
        ...
        code = (
            ...
            "assert zero_mem.__version__ == '1.2.0'; "
            "assert m.version('zero-mem') == '1.2.0'; "
        ...
        assert version_flag == "zero-mem 1.2.0"
        assert version_command == "1.2.0"
