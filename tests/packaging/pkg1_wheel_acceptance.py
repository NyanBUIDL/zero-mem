...
Usage: python tests/packaging/pkg1_wheel_acceptance.py dist/zero_mem-1.0.0-py3-none-any.whl
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="Zero Mem PKG1 Test ") as temp:
        ...
        code = (
            ...
            "assert zero_mem.__version__ == '1.0.0'; "
            "assert m.version('zero-mem') == '1.0.0'; "
        ...
        assert version_flag == "zero-mem 1.0.0"
        assert version_command == "1.0.0"
