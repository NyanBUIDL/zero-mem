...
class ReasonCode(str, Enum):
    ...
    ALLOW_EXPLICIT_CROSS_PROFILE_READ = "ALLOW_EXPLICIT_CROSS_PROFILE_READ"
    ALLOW_EXPLICIT_CROSS_PROFILE_WRITE = "ALLOW_EXPLICIT_CROSS_PROFILE_WRITE"
    DENY_GLOBAL_WRITE = "DENY_GLOBAL_WRITE"
    DENY_POLICY_CONFLICT = "DENY_POLICY_CONFLICT"
    DENY_CROSS_PROFILE_READ = "DENY_CROSS_PROFILE_READ"
    DENY_CROSS_PROFILE_WRITE = "DENY_CROSS_PROFILE_WRITE"
    DENY_UNAUTHORIZED_CROSS_PROFILE_READ = "DENY_UNAUTHORIZED_CROSS_PROFILE_READ"
